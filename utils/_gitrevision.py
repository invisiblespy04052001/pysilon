...
#
rev = "09b8a1ebd0"  # abbreviated commit hash
commit = "09b8a1ebd0a62c4e61de61cd33c739c997249a89"  # commit hash
date = "2022-10-31 17:45:24 +0000"  # commit date
author = "Brénainn Woodsend <bwoodsend@gmail.com>"
ref_names = "tag: v5.6.2"  # incl. current branch
commit_message = """Release v5.6.2. [skip ci]
"""
